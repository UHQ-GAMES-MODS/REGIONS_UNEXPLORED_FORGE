...
public class RuItems {
    ...
    CHERRY_BOAT = RegionsUnexploredMod.ITEM_REGISTRY.register("cherry_boat", () -> new RuBoatItem(false, RuBoat.ModelType.CHERRY, (new Item.Properties()).stacksTo(1)));
    CHERRY_CHEST_BOAT = RegionsUnexploredMod.ITEM_REGISTRY.register("cherry_chest_boat", () -> new RuBoatItem(true, RuBoat.ModelType.CHERRY, (new Item.Properties()).stacksTo(1)));
