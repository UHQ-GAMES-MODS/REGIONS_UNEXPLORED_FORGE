...
public class RuItems {
    ...
    public static void addItems(){
        ...
        BLACKWOOD_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("blackwood_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.BLACKWOOD_SIGN.get(), RuBlocks.BLACKWOOD_WALL_SIGN.get()));
        MAGNOLIA_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("magnolia_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.MAGNOLIA_SIGN.get(), RuBlocks.MAGNOLIA_WALL_SIGN.get()));
        CYPRESS_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("cypress_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.CYPRESS_SIGN.get(), RuBlocks.CYPRESS_WALL_SIGN.get()));
        DEAD_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("dead_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.DEAD_SIGN.get(), RuBlocks.DEAD_WALL_SIGN.get()));
        EUCALYPTUS_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("eucalyptus_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.EUCALYPTUS_SIGN.get(), RuBlocks.EUCALYPTUS_WALL_SIGN.get()));
        JOSHUA_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("joshua_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.JOSHUA_SIGN.get(), RuBlocks.JOSHUA_WALL_SIGN.get()));
        LARCH_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("larch_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.LARCH_SIGN.get(), RuBlocks.LARCH_WALL_SIGN.get()));
        MAPLE_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("maple_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.MAPLE_SIGN.get(), RuBlocks.MAPLE_WALL_SIGN.get()));
        MAUVE_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("mauve_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.MAUVE_SIGN.get(), RuBlocks.MAUVE_WALL_SIGN.get()));
        PALM_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("palm_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.PALM_SIGN.get(), RuBlocks.PALM_WALL_SIGN.get()));
        PINE_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("pine_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.PINE_SIGN.get(), RuBlocks.PINE_WALL_SIGN.get()));
        REDWOOD_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("redwood_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.REDWOOD_SIGN.get(), RuBlocks.REDWOOD_WALL_SIGN.get()));
        BRIMWOOD_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("brimwood_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.BRIMWOOD_SIGN.get(), RuBlocks.BRIMWOOD_WALL_SIGN.get()));
        WILLOW_HANGING_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("willow_hanging_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.WILLOW_SIGN.get(), RuBlocks.WILLOW_WALL_SIGN.get()));
