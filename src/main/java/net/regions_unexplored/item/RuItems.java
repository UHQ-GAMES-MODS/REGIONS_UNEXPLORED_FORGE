...
public class RuItems {
    ...
    public static void addItems(){
        ...
        COBALT_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("cobalt_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.COBALT_SIGN.get(), RuBlocks.COBALT_WALL_SIGN.get()));
        ...
        PINK_BIOSHROOM_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("pink_bioshroom_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.PINK_BIOSHROOM_SIGN.get(), RuBlocks.PINK_BIOSHROOM_WALL_SIGN.get()));
        ...
        SOCOTRA_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("socotra_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.SOCOTRA_SIGN.get(), RuBlocks.SOCOTRA_WALL_SIGN.get()));
        ...
        YELLOW_BIOSHROOM_SIGN = RegionsUnexploredMod.ITEM_REGISTRY.register("yellow_bioshroom_sign", () -> new SignItem(new Item.Properties().stacksTo(16), RuBlocks.YELLOW_BIOSHROOM_SIGN.get(), RuBlocks.YELLOW_BIOSHROOM_WALL_SIGN.get()));
        ...
        SOCOTRA_BOAT = RegionsUnexploredMod.ITEM_REGISTRY.register("socotra_boat", () -> new RuBoatItem(false, RuBoat.ModelType.SOCOTRA, (new Item.Properties()).stacksTo(1)));
        SOCOTRA_CHEST_BOAT = RegionsUnexploredMod.ITEM_REGISTRY.register("socotra_chest_boat", () -> new RuBoatItem(true, RuBoat.ModelType.SOCOTRA, (new Item.Properties()).stacksTo(1)));
