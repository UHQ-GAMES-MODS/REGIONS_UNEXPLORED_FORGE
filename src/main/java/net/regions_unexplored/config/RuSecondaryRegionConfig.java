...
public class RuSecondaryRegionConfig {
    ...
    static {
        ...
        MID_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        MID_NEUTRAL_WET = BUILDER.define("neutral_wet", RuBiomes.CLOVER_PLAINS.location().toString());
        ...
        MID_VAR_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        MID_VAR_NEUTRAL_WET = BUILDER.define("neutral_wet", RuBiomes.CLOVER_PLAINS.location().toString());
        ...
        BUILDER.comment("warm_biomes");
        PLT_WARM_ARID = BUILDER.define("warm_arid", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_WARM_DRY = BUILDER.define("warm_dry", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_WARM_WET = BUILDER.define("warm_wet", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        ...
        PLT_VAR_NEUTRAL_DRY = BUILDER.define("neutral_dry", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_VAR_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_VAR_NEUTRAL_WET = BUILDER.define("neutral_wet", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_VAR_NEUTRAL_HUMID = BUILDER.define("neutral_humid", RuBiomes.BLACKWOOD_TAIGA.location().toString());
        BUILDER.comment("warm_biomes");
        PLT_VAR_WARM_ARID = BUILDER.define("warm_arid", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_VAR_WARM_DRY = BUILDER.define("warm_dry", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
        PLT_VAR_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.MAGNOLIA_WOODLAND.location().toString());
