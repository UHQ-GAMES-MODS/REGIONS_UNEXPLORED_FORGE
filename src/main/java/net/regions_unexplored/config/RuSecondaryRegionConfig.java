...
public class RuSecondaryRegionConfig {
    ...
    static {
        ...
        OCA_DEP_ICY = BUILDER.define("ocean_deep_icy", "regions_unexplored:hyacinth_deeps");
        OCA_DEP_COOL = BUILDER.define("ocean_deep_cool", "minecraft:deep_cold_ocean");
        OCA_DEP_NEUTRAL = BUILDER.define("ocean_deep_neutral", "minecraft:deep_ocean");
        OCA_DEP_WARM = BUILDER.define("ocean_deep_warm", "minecraft:deep_lukewarm_ocean");
        OCA_DEP_HOT = BUILDER.define("ocean_deep_hot", "minecraft:warm_ocean");
        BUILDER.comment("oceans");
        OCA_ICY = BUILDER.define("ocean_icy", "minecraft:frozen_ocean");
        OCA_COOL = BUILDER.define("ocean_cool", "minecraft:cold_ocean");
        OCA_NEUTRAL = BUILDER.define("ocean_neutral", "minecraft:ocean");
        OCA_WARM = BUILDER.define("ocean_warm", "minecraft:lukewarm_ocean");
        OCA_HOT = BUILDER.define("ocean_hot", "regions_unexplored:rocky_reef");
        BUILDER.pop();
