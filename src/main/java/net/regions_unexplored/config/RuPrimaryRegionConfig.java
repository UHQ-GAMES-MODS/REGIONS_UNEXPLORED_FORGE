...
public class RuPrimaryRegionConfig {
    ...
    static {
        ...
        COLD_STONE_BEACH = BUILDER.define("cold_stone_beach_biome", DefaultBiomes.PRIMARY_STONE_SHORE_BIOMES[1].location().toString());
        HOT_STONE_BEACH = BUILDER.define("hot_stone_beach_biome", DefaultBiomes.PRIMARY_STONE_SHORE_BIOMES[4].location().toString());
        BUILDER.pop();
