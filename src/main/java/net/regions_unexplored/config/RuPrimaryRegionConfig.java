...
public class RuPrimaryRegionConfig {
    ...
    static {
        ...
        MID_ICY_ARID = BUILDER.define("icy_arid", RuBiomes.ICY_DESERT.location().toString());
        MID_ICY_DRY = BUILDER.define("icy_dry", RuBiomes.FROZEN_TUNDRA.location().toString());
        MID_ICY_NEUTRAL = BUILDER.define("icy_neutral", RuBiomes.FROZEN_FOREST.location().toString());
        MID_ICY_WET = BUILDER.define("icy_wet", RuBiomes.COLD_BOREAL_FOREST.location().toString());
        MID_ICY_HUMID = BUILDER.define("icy_humid", RuBiomes.COLD_BOREAL_FOREST.location().toString());
        BUILDER.comment("cool_biomes");
        MID_COOL_ARID = BUILDER.define("cool_arid", RuBiomes.PUMPKIN_FIELDS.location().toString());
        ...
        MID_COOL_HUMID = BUILDER.define("cool_humid", RuBiomes.BOREAL_FOREST.location().toString());
        BUILDER.comment("neutral_biomes");
        MID_NEUTRAL_ARID = BUILDER.define("neutral_arid", RuBiomes.ORCHARD.location().toString());
        ...
        MID_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.BARLEY_FIELDS.location().toString());
        ...
        MID_HOT_ARID = BUILDER.define("hot_arid", RuBiomes.BAOBAB_SAVANNA.location().toString());
        MID_HOT_DRY = BUILDER.define("hot_dry", RuBiomes.BAOBAB_SAVANNA.location().toString());
        MID_HOT_NEUTRAL = BUILDER.define("hot_neutral", RuBiomes.SAGUARO_DESERT.location().toString());
        MID_HOT_WET = BUILDER.define("hot_wet", RuBiomes.SAGUARO_DESERT.location().toString());
        MID_HOT_HUMID = BUILDER.define("hot_humid", RuBiomes.OLD_GROWTH_RAINFOREST.location().toString());
        BUILDER.pop();
        BUILDER.push("-----------------MIDDLE_BIOMES_VARIANT--------------------");
        BUILDER.comment("icy_biomes");
        MID_VAR_ICY_ARID = BUILDER.define("icy_arid", RuBiomes.ICY_DESERT.location().toString());
        ...
        MID_VAR_ICY_WET = BUILDER.define("icy_wet", RuBiomes.COLD_BOREAL_FOREST.location().toString());
        ...
        MID_VAR_COOL_WET = BUILDER.define("cool_wet", RuBiomes.BOREAL_FOREST.location().toString());
        MID_VAR_COOL_HUMID = BUILDER.define("cool_humid", RuBiomes.GOLDEN_BOREAL_FOREST.location().toString());
        BUILDER.comment("neutral_biomes");
        MID_VAR_NEUTRAL_ARID = BUILDER.define("neutral_arid", RuBiomes.ORCHARD.location().toString());
        ...
        MID_VAR_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.PRAIRIE.location().toString());
        MID_VAR_WARM_WET = BUILDER.define("warm_wet", RuBiomes.REDWOODS.location().toString());
        MID_VAR_WARM_HUMID = BUILDER.define("warm_humid", RuBiomes.SPARSE_REDWOODS.location().toString());
        BUILDER.comment("hot_biomes");
        MID_VAR_HOT_ARID = BUILDER.define("hot_arid", RuBiomes.BAOBAB_SAVANNA.location().toString());
        ...
        PLT_ICY_HUMID = BUILDER.define("icy_humid", RuBiomes.COLD_BOREAL_FOREST.location().toString());
        BUILDER.comment("cool_biomes");
        PLT_COOL_ARID = BUILDER.define("cool_arid", RuBiomes.AUTUMNAL_MAPLE_FOREST.location().toString());
        ...
        PLT_COOL_WET = BUILDER.define("cool_wet", RuBiomes.BOREAL_FOREST.location().toString());
        PLT_COOL_HUMID = BUILDER.define("cool_humid", RuBiomes.BOREAL_FOREST.location().toString());
        BUILDER.comment("neutral_biomes");
        ...
        PLT_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.DECIDUOUS_FOREST.location().toString());
        PLT_WARM_WET = BUILDER.define("warm_wet", RuBiomes.REDWOODS.location().toString());
        ...
        PLT_HOT_WET = BUILDER.define("hot_wet", RuBiomes.RAINFOREST.location().toString());
        PLT_HOT_HUMID = BUILDER.define("hot_humid", RuBiomes.RAINFOREST.location().toString());
        BUILDER.pop();
        ...
        PLT_VAR_COOL_DRY = BUILDER.define("cool_dry", RuBiomes.SILVER_BIRCH_FOREST.location().toString());
        PLT_VAR_COOL_NEUTRAL = BUILDER.define("cool_neutral", RuBiomes.MAPLE_FOREST.location().toString());
        PLT_VAR_COOL_WET = BUILDER.define("cool_wet", RuBiomes.BOREAL_FOREST.location().toString());
        PLT_VAR_COOL_HUMID = BUILDER.define("cool_humid", RuBiomes.GOLDEN_BOREAL_FOREST.location().toString());
        BUILDER.comment("neutral_biomes");
        ...
        PLT_VAR_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.DECIDUOUS_FOREST.location().toString());
        PLT_VAR_WARM_WET = BUILDER.define("warm_wet", RuBiomes.REDWOODS.location().toString());
        ...
        BUILDER.comment("neutral_biomes");
        SHT_NEUTRAL_ARID = BUILDER.define("neutral_arid", RuBiomes.LUSH_HILLS.location().toString());
        SHT_NEUTRAL_DRY = BUILDER.define("neutral_dry", RuBiomes.LUSH_HILLS.location().toString());
        SHT_NEUTRAL_NEUTRAL = BUILDER.define("neutral_neutral", RuBiomes.LUSH_HILLS.location().toString());
        SHT_NEUTRAL_WET = BUILDER.define("neutral_wet", RuBiomes.LUSH_HILLS.location().toString());
        SHT_NEUTRAL_HUMID = BUILDER.define("neutral_humid", RuBiomes.LUSH_HILLS.location().toString());
        BUILDER.comment("warm_biomes");
        SHT_WARM_ARID = BUILDER.define("warm_arid", RuBiomes.DECIDUOUS_FOREST.location().toString());
        SHT_WARM_DRY = BUILDER.define("warm_dry", RuBiomes.DECIDUOUS_FOREST.location().toString());
        SHT_WARM_NEUTRAL = BUILDER.define("warm_neutral", RuBiomes.PRAIRIE.location().toString());
        ...
        BUILDER.comment("hot_biomes");
        SHT_HOT_ARID = BUILDER.define("hot_arid", RuBiomes.BAOBAB_SAVANNA.location().toString());
        SHT_HOT_DRY = BUILDER.define("hot_dry", RuBiomes.BAOBAB_SAVANNA.location().toString());
        SHT_HOT_NEUTRAL = BUILDER.define("hot_neutral", RuBiomes.SAGUARO_DESERT.location().toString());
        SHT_HOT_WET = BUILDER.define("hot_wet", RuBiomes.SAGUARO_DESERT.location().toString());
        SHT_HOT_HUMID = BUILDER.define("hot_humid", RuBiomes.RAINFOREST.location().toString());
        BUILDER.pop();
