...
public class MediumJoshuaTreeFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean placeBranch(LevelAccessor level, BlockPos pos) {
        ...
        if(level.getBlockState(north.north().north().above().above()).getMaterial().isReplaceable()&&!level.isOutsideBuildHeight(north.north().north().above().above())){
        ...
        if(level.getBlockState(south.south().south().above().above()).getMaterial().isReplaceable()&&!level.isOutsideBuildHeight(south.south().south().above().above())){
        ...
        if(level.getBlockState(east.east().east().above().above()).getMaterial().isReplaceable()&&!level.isOutsideBuildHeight(east.east().east().above().above())){
        ...
        if(level.getBlockState(west.west().west().above().above()).getMaterial().isReplaceable()&&!level.isOutsideBuildHeight(west.west().west().above().above())){
