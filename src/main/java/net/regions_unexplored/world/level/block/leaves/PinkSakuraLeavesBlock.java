...
public class PinkSakuraLeavesBlock extends LeavesBlock {
   public PinkSakuraLeavesBlock(Properties p_273704_) {
      super(p_273704_);
   }
   ...
   public void animateTick(BlockState p_272714_, Level p_272837_, BlockPos p_273218_, RandomSource p_273360_) {
      ...
      if (p_273360_.nextInt(10) == 0) {
         ...
         if (!isFaceFull(blockstate.getCollisionShape(p_272837_, blockpos), Direction.UP)) {
            if(RuCommonConfig.TOGGLE_PINK_SAKURA_LEAVES_PARTICLE.get()) {
            spawnParticleBelow(p_272837_, p_273218_, p_273360_, (ParticleOptions) RuParticleTypes.PINK_SAKURA_LEAVES.get());
            }
         }
      }
   }
