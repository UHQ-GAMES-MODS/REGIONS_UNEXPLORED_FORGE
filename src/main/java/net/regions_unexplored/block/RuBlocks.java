...
public class RuBlocks {
    ...
    public static void addBlocks() {
        ...
        SAKURA_LEAVES = BlockRegistry.registerDefaultBlock("sakura_leaves", () -> BlockRegistry.leaves(MaterialColor.PLANT));
        ...
        PINK_SAKURA_LEAVES = BlockRegistry.registerDefaultBlock("pink_sakura_leaves", () -> BlockRegistry.cherryLeaves(MaterialColor.COLOR_PINK));
        REDWOOD_LEAVES = BlockRegistry.registerDefaultBlock("redwood_leaves", () -> BlockRegistry.leaves(MaterialColor.PLANT));
        RED_SAKURA_LEAVES = BlockRegistry.registerDefaultBlock("red_sakura_leaves", () -> BlockRegistry.cherryLeaves(MaterialColor.COLOR_RED));
        ...
        WHITE_SAKURA_LEAVES = BlockRegistry.registerDefaultBlock("white_sakura_leaves", () -> BlockRegistry.cherryLeaves(MaterialColor.TERRACOTTA_WHITE));
        ...
        /*-----------------DIRT_BLOCKS-----------------*/
        //FOREST_DIRT_BLOCKS
        FOREST_GRASS_BLOCK = BlockRegistry.registerDefaultBlock("forest_grass_block", () -> new ForestGrassBlock(BlockBehaviour.Properties.copy(Blocks.GRASS_BLOCK)));
        FOREST_DIRT = BlockRegistry.registerDefaultBlock("forest_dirt", () -> new TillableDirtBlock(BlockBehaviour.Properties.copy(Blocks.DIRT)));
        ...
        FOREST_COARSE_DIRT = BlockRegistry.registerDefaultBlock("forest_coarse_dirt", () -> new TillableDirtBlock(BlockBehaviour.Properties.copy(Blocks.COARSE_DIRT)));
        ...
        //PLAINS_DIRT_BLOCKS
        PLAINS_GRASS_BLOCK = BlockRegistry.registerDefaultBlock("plains_grass_block", () -> new PlainsGrassBlock(BlockBehaviour.Properties.copy(Blocks.GRASS_BLOCK)));
        PLAINS_DIRT = BlockRegistry.registerDefaultBlock("plains_dirt", () -> new TillableDirtBlock(BlockBehaviour.Properties.copy(Blocks.DIRT)));
        ...
        PLAINS_COARSE_DIRT = BlockRegistry.registerDefaultBlock("plains_coarse_dirt", () -> new TillableDirtBlock(BlockBehaviour.Properties.copy(Blocks.COARSE_DIRT)));
        ...
        //ASHEN_BLOCKS
        ASHEN_LOG = BlockRegistry.registerDefaultBlock("ashen_log", () -> BlockRegistry.log(MaterialColor.COLOR_LIGHT_GRAY, MaterialColor.COLOR_GRAY, SoundType.NETHER_WOOD));
        ASHEN_WOOD = BlockRegistry.registerDefaultBlock("ashen_wood", () -> BlockRegistry.log(MaterialColor.COLOR_LIGHT_GRAY, MaterialColor.COLOR_LIGHT_GRAY, SoundType.NETHER_WOOD));
        //BAOBAB_BLOCKS
        BAOBAB_LOG = BlockRegistry.registerDefaultBlock("baobab_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.TERRACOTTA_LIGHT_GRAY, SoundType.CHERRY_WOOD));
        STRIPPED_BAOBAB_LOG = BlockRegistry.registerDefaultBlock("stripped_baobab_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        BAOBAB_WOOD = BlockRegistry.registerDefaultBlock("baobab_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_LIGHT_GRAY).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        STRIPPED_BAOBAB_WOOD = BlockRegistry.registerDefaultBlock("stripped_baobab_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        BAOBAB_PLANKS = BlockRegistry.registerDefaultBlock("baobab_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.CHERRY_WOOD)));
        BAOBAB_STAIRS = BlockRegistry.registerDefaultBlock("baobab_stairs", () -> BlockRegistry.woodStairs(MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        BAOBAB_SLAB = BlockRegistry.registerDefaultBlock("baobab_slab", () -> BlockRegistry.woodSlab(MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        BAOBAB_FENCE = BlockRegistry.registerDefaultBlock("baobab_fence", () -> BlockRegistry.woodFence(MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        BAOBAB_DOOR = BlockRegistry.registerDefaultBlock("baobab_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion(), BlockSetType.OAK));
        BAOBAB_FENCE_GATE = BlockRegistry.registerDefaultBlock("baobab_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.BAOBAB, SoundType.CHERRY_WOOD));
        BAOBAB_TRAPDOOR = BlockRegistry.registerDefaultBlock("baobab_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.BAOBAB));
        BAOBAB_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("baobab_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD), RuBlockSetType.BAOBAB));
        BAOBAB_BUTTON = BlockRegistry.registerDefaultBlock("baobab_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD), RuBlockSetType.BAOBAB, 30, true));
        BAOBAB_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("baobab_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD), RuWoodTypes.BAOBAB));
        BAOBAB_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("baobab_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD).dropsLike(BAOBAB_SIGN.get()), RuWoodTypes.BAOBAB));
        //BLACKWOOD_BLOCKS
        BLACKWOOD_LOG = BlockRegistry.registerDefaultBlock("blackwood_log", () -> BlockRegistry.log(MaterialColor.TERRACOTTA_BLACK, MaterialColor.TERRACOTTA_BROWN, SoundType.NETHER_WOOD));
        STRIPPED_BLACKWOOD_LOG = BlockRegistry.registerDefaultBlock("stripped_blackwood_log", () -> BlockRegistry.log(MaterialColor.TERRACOTTA_BLACK, MaterialColor.TERRACOTTA_BLACK, SoundType.NETHER_WOOD));
        BLACKWOOD_WOOD = BlockRegistry.registerDefaultBlock("blackwood_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BROWN).strength(2.0F).sound(SoundType.NETHER_WOOD)));
        STRIPPED_BLACKWOOD_WOOD = BlockRegistry.registerDefaultBlock("stripped_blackwood_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).strength(2.0F).sound(SoundType.NETHER_WOOD)));
        BLACKWOOD_PLANKS = BlockRegistry.registerDefaultBlock("blackwood_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).strength(2.0F, 3.0F).sound(SoundType.NETHER_WOOD)));
        BLACKWOOD_STAIRS = BlockRegistry.registerDefaultBlock("blackwood_stairs", () -> BlockRegistry.woodStairs(MaterialColor.TERRACOTTA_BLACK, SoundType.NETHER_WOOD));
        BLACKWOOD_SLAB = BlockRegistry.registerDefaultBlock("blackwood_slab", () -> BlockRegistry.woodSlab(MaterialColor.TERRACOTTA_BLACK, SoundType.NETHER_WOOD));
        BLACKWOOD_FENCE = BlockRegistry.registerDefaultBlock("blackwood_fence", () -> BlockRegistry.woodFence(MaterialColor.TERRACOTTA_BLACK, SoundType.NETHER_WOOD));
        BLACKWOOD_DOOR = BlockRegistry.registerDefaultBlock("blackwood_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).strength(3.0F).sound(SoundType.NETHER_WOOD).noOcclusion(), RuBlockSetType.BLACKWOOD));
        BLACKWOOD_FENCE_GATE = BlockRegistry.registerDefaultBlock("blackwood_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.TERRACOTTA_BLACK, RuWoodTypes.BLACKWOOD, SoundType.NETHER_WOOD));
        BLACKWOOD_TRAPDOOR = BlockRegistry.registerDefaultBlock("blackwood_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).strength(3.0F).sound(SoundType.NETHER_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.BLACKWOOD));
        BLACKWOOD_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("blackwood_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).noCollission().strength(0.5F).sound(SoundType.NETHER_WOOD), RuBlockSetType.BLACKWOOD));
        BLACKWOOD_BUTTON = BlockRegistry.registerDefaultBlock("blackwood_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.NETHER_WOOD), RuBlockSetType.BLACKWOOD, 30, true));
        BLACKWOOD_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("blackwood_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.NETHER_WOOD), RuWoodTypes.BLACKWOOD));
        BLACKWOOD_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("blackwood_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.NETHER_WOOD).dropsLike(BLACKWOOD_SIGN.get()), RuWoodTypes.BLACKWOOD));
        //BRIMWOOD_BLOCKS
        ...
        BRIMWOOD_FENCE = BlockRegistry.registerDefaultBlock("brimwood_fence", () -> BlockRegistry.woodFence(MaterialColor.COLOR_ORANGE, SoundType.NETHER_WOOD));
        BRIMWOOD_DOOR = BlockRegistry.registerDefaultBlock("brimwood_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).strength(3.0F).sound(SoundType.NETHER_WOOD).noOcclusion(), RuBlockSetType.BRIMWOOD));
        BRIMWOOD_FENCE_GATE = BlockRegistry.registerDefaultBlock("brimwood_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.COLOR_ORANGE, RuWoodTypes.BRIMWOOD, SoundType.NETHER_WOOD));
        BRIMWOOD_TRAPDOOR = BlockRegistry.registerDefaultBlock("brimwood_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).strength(3.0F).sound(SoundType.NETHER_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.BRIMWOOD));
        BRIMWOOD_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("brimwood_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).noCollission().strength(0.5F).sound(SoundType.NETHER_WOOD), RuBlockSetType.BRIMWOOD));
        BRIMWOOD_BUTTON = BlockRegistry.registerDefaultBlock("brimwood_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.NETHER_WOOD), RuBlockSetType.BRIMWOOD, 30, true));
        ...
        //CHERRY_BLOCKS
        SAKURA_LOG = BlockRegistry.registerDefaultBlock("sakura_log", () -> BlockRegistry.log(MaterialColor.TERRACOTTA_PINK, MaterialColor.STONE, SoundType.CHERRY_WOOD));
        STRIPPED_SAKURA_LOG = BlockRegistry.registerDefaultBlock("stripped_sakura_log", () -> BlockRegistry.log(MaterialColor.TERRACOTTA_PINK, MaterialColor.TERRACOTTA_PINK, SoundType.CHERRY_WOOD));
        SAKURA_WOOD = BlockRegistry.registerDefaultBlock("sakura_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.STONE).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        STRIPPED_SAKURA_WOOD = BlockRegistry.registerDefaultBlock("stripped_sakura_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        SAKURA_PLANKS = BlockRegistry.registerDefaultBlock("sakura_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).strength(2.0F, 3.0F).sound(SoundType.CHERRY_WOOD)));
        ...
        CYPRESS_WOOD = BlockRegistry.registerDefaultBlock("cypress_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.BAMBOO_WOOD)));
        STRIPPED_CYPRESS_WOOD = BlockRegistry.registerDefaultBlock("stripped_cypress_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.BAMBOO_WOOD)));
        CYPRESS_PLANKS = BlockRegistry.registerDefaultBlock("cypress_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.BAMBOO_WOOD)));
        CYPRESS_STAIRS = BlockRegistry.registerDefaultBlock("cypress_stairs", () -> BlockRegistry.woodStairs(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        CYPRESS_SLAB = BlockRegistry.registerDefaultBlock("cypress_slab", () -> BlockRegistry.woodSlab(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        CYPRESS_FENCE = BlockRegistry.registerDefaultBlock("cypress_fence", () -> BlockRegistry.woodFence(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        CYPRESS_DOOR = BlockRegistry.registerDefaultBlock("cypress_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.BAMBOO_WOOD).noOcclusion(), RuBlockSetType.CYPRESS));
        CYPRESS_FENCE_GATE = BlockRegistry.registerDefaultBlock("cypress_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.CYPRESS, SoundType.BAMBOO_WOOD));
        CYPRESS_TRAPDOOR = BlockRegistry.registerDefaultBlock("cypress_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.BAMBOO_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.CYPRESS));
        CYPRESS_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("cypress_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().strength(0.5F).sound(SoundType.BAMBOO_WOOD), RuBlockSetType.CYPRESS));
        CYPRESS_BUTTON = BlockRegistry.registerDefaultBlock("cypress_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.BAMBOO_WOOD), RuBlockSetType.CYPRESS, 30, true));
        CYPRESS_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("cypress_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.BAMBOO_WOOD), RuWoodTypes.CYPRESS));
        CYPRESS_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("cypress_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.BAMBOO_WOOD).dropsLike(CYPRESS_SIGN.get()), RuWoodTypes.CYPRESS));
        //DEAD_BLOCKS
        DEAD_LOG = BlockRegistry.registerDefaultBlock("dead_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.WOOD));
        STRIPPED_DEAD_LOG = BlockRegistry.registerDefaultBlock("stripped_dead_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.WOOD));
        ...
        DEAD_STAIRS = BlockRegistry.registerDefaultBlock("dead_stairs", () -> BlockRegistry.woodStairs(MaterialColor.WOOD, SoundType.WOOD));
        DEAD_SLAB = BlockRegistry.registerDefaultBlock("dead_slab", () -> BlockRegistry.woodSlab(MaterialColor.WOOD, SoundType.WOOD));
        DEAD_FENCE = BlockRegistry.registerDefaultBlock("dead_fence", () -> BlockRegistry.woodFence(MaterialColor.WOOD, SoundType.WOOD));
        ...
        DEAD_FENCE_GATE = BlockRegistry.registerDefaultBlock("dead_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.DEAD, SoundType.WOOD));
        ...
        EUCALYPTUS_FENCE_GATE = BlockRegistry.registerDefaultBlock("eucalyptus_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.EUCALYPTUS, SoundType.WOOD));
        ...
        JOSHUA_FENCE_GATE = BlockRegistry.registerDefaultBlock("joshua_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.JOSHUA, SoundType.WOOD));
        ...
        LARCH_FENCE_GATE = BlockRegistry.registerDefaultBlock("larch_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.LARCH, SoundType.WOOD));
        ...
        MAPLE_FENCE_GATE = BlockRegistry.registerDefaultBlock("maple_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.MAPLE, SoundType.WOOD));
        ...
        //MAUVE_BLOCKS
        MAUVE_LOG = BlockRegistry.registerDefaultBlock("mauve_log", () -> BlockRegistry.log(MaterialColor.TERRACOTTA_PURPLE, MaterialColor.PODZOL, SoundType.CHERRY_WOOD));
        STRIPPED_MAUVE_LOG = BlockRegistry.registerDefaultBlock("stripped_mauve_log", () -> BlockRegistry.log(MaterialColor.TERRACOTTA_PURPLE, MaterialColor.TERRACOTTA_PURPLE, SoundType.CHERRY_WOOD));
        MAUVE_WOOD = BlockRegistry.registerDefaultBlock("mauve_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        STRIPPED_MAUVE_WOOD = BlockRegistry.registerDefaultBlock("stripped_mauve_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        MAUVE_PLANKS = BlockRegistry.registerDefaultBlock("mauve_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).strength(2.0F, 3.0F).sound(SoundType.CHERRY_WOOD)));
        MAUVE_STAIRS = BlockRegistry.registerDefaultBlock("mauve_stairs", () -> BlockRegistry.woodStairs(MaterialColor.TERRACOTTA_PURPLE, SoundType.CHERRY_WOOD));
        MAUVE_SLAB = BlockRegistry.registerDefaultBlock("mauve_slab", () -> BlockRegistry.woodSlab(MaterialColor.TERRACOTTA_PURPLE, SoundType.CHERRY_WOOD));
        MAUVE_FENCE = BlockRegistry.registerDefaultBlock("mauve_fence", () -> BlockRegistry.woodFence(MaterialColor.TERRACOTTA_PURPLE, SoundType.CHERRY_WOOD));
        MAUVE_DOOR = BlockRegistry.registerDefaultBlock("mauve_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion(), RuBlockSetType.MAUVE));
        MAUVE_FENCE_GATE = BlockRegistry.registerDefaultBlock("mauve_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.TERRACOTTA_PURPLE, RuWoodTypes.MAUVE, SoundType.CHERRY_WOOD));
        MAUVE_TRAPDOOR = BlockRegistry.registerDefaultBlock("mauve_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.MAUVE));
        MAUVE_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("mauve_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PURPLE).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD), RuBlockSetType.MAUVE));
        MAUVE_BUTTON = BlockRegistry.registerDefaultBlock("mauve_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD), RuBlockSetType.MAUVE, 30, true));
        MAUVE_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("mauve_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD), RuWoodTypes.MAUVE));
        MAUVE_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("mauve_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD).dropsLike(MAUVE_SIGN.get()), RuWoodTypes.MAUVE));
        //PALM_BLOCKS
        PALM_LOG = BlockRegistry.registerDefaultBlock("palm_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        STRIPPED_PALM_LOG = BlockRegistry.registerDefaultBlock("stripped_palm_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PALM_WOOD = BlockRegistry.registerDefaultBlock("palm_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.BAMBOO_WOOD)));
        STRIPPED_PALM_WOOD = BlockRegistry.registerDefaultBlock("stripped_palm_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.BAMBOO_WOOD)));
        PALM_PLANKS = BlockRegistry.registerDefaultBlock("palm_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.BAMBOO_WOOD)));
        PALM_STAIRS = BlockRegistry.registerDefaultBlock("palm_stairs", () -> BlockRegistry.woodStairs(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PALM_SLAB = BlockRegistry.registerDefaultBlock("palm_slab", () -> BlockRegistry.woodSlab(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PALM_FENCE = BlockRegistry.registerDefaultBlock("palm_fence", () -> BlockRegistry.woodFence(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PALM_DOOR = BlockRegistry.registerDefaultBlock("palm_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.BAMBOO_WOOD).noOcclusion(), RuBlockSetType.PALM));
        PALM_FENCE_GATE = BlockRegistry.registerDefaultBlock("palm_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.PALM, SoundType.BAMBOO_WOOD));
        PALM_TRAPDOOR = BlockRegistry.registerDefaultBlock("palm_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.BAMBOO_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.PALM));
        PALM_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("palm_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().strength(0.5F).sound(SoundType.BAMBOO_WOOD), RuBlockSetType.PALM));
        PALM_BUTTON = BlockRegistry.registerDefaultBlock("palm_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.BAMBOO_WOOD), RuBlockSetType.PALM, 30, true));
        PALM_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("palm_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.BAMBOO_WOOD), RuWoodTypes.PALM));
        PALM_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("palm_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.BAMBOO_WOOD).dropsLike(PALM_SIGN.get()), RuWoodTypes.PALM));
        //PINE_BLOCKS
        PINE_LOG = BlockRegistry.registerDefaultBlock("pine_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PINE_LOG_TRANSITION = BlockRegistry.registerDefaultBlock("pine_log_transition", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        STRIPPED_PINE_LOG = BlockRegistry.registerDefaultBlock("stripped_pine_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PINE_WOOD = BlockRegistry.registerDefaultBlock("pine_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.BAMBOO_WOOD)));
        STRIPPED_PINE_WOOD = BlockRegistry.registerDefaultBlock("stripped_pine_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.BAMBOO_WOOD)));
        PINE_PLANKS = BlockRegistry.registerDefaultBlock("pine_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.BAMBOO_WOOD)));
        PINE_STAIRS = BlockRegistry.registerDefaultBlock("pine_stairs", () -> BlockRegistry.woodStairs(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PINE_SLAB = BlockRegistry.registerDefaultBlock("pine_slab", () -> BlockRegistry.woodSlab(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PINE_FENCE = BlockRegistry.registerDefaultBlock("pine_fence", () -> BlockRegistry.woodFence(MaterialColor.WOOD, SoundType.BAMBOO_WOOD));
        PINE_DOOR = BlockRegistry.registerDefaultBlock("pine_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.BAMBOO_WOOD).noOcclusion(), RuBlockSetType.PINE));
        PINE_FENCE_GATE = BlockRegistry.registerDefaultBlock("pine_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.PINE, SoundType.BAMBOO_WOOD));
        PINE_TRAPDOOR = BlockRegistry.registerDefaultBlock("pine_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.BAMBOO_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.PINE));
        PINE_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("pine_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().strength(0.5F).sound(SoundType.BAMBOO_WOOD), RuBlockSetType.PINE));
        PINE_BUTTON = BlockRegistry.registerDefaultBlock("pine_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.BAMBOO_WOOD), RuBlockSetType.PINE, 30, true));
        PINE_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("pine_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.BAMBOO_WOOD), RuWoodTypes.PINE));
        PINE_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("pine_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.BAMBOO_WOOD).dropsLike(PINE_SIGN.get()), RuWoodTypes.PINE));
        //REDWOOD_BLOCKS
        REDWOOD_LOG = BlockRegistry.registerDefaultBlock("redwood_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        STRIPPED_REDWOOD_LOG = BlockRegistry.registerDefaultBlock("stripped_redwood_log", () -> BlockRegistry.log(MaterialColor.WOOD, MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        REDWOOD_WOOD = BlockRegistry.registerDefaultBlock("redwood_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        STRIPPED_REDWOOD_WOOD = BlockRegistry.registerDefaultBlock("stripped_redwood_wood", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F).sound(SoundType.CHERRY_WOOD)));
        REDWOOD_PLANKS = BlockRegistry.registerDefaultBlock("redwood_planks", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.CHERRY_WOOD)));
        REDWOOD_STAIRS = BlockRegistry.registerDefaultBlock("redwood_stairs", () -> BlockRegistry.woodStairs(MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        REDWOOD_SLAB = BlockRegistry.registerDefaultBlock("redwood_slab", () -> BlockRegistry.woodSlab(MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        REDWOOD_FENCE = BlockRegistry.registerDefaultBlock("redwood_fence", () -> BlockRegistry.woodFence(MaterialColor.WOOD, SoundType.CHERRY_WOOD));
        REDWOOD_DOOR = BlockRegistry.registerDefaultBlock("redwood_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion(), RuBlockSetType.REDWOOD));
        REDWOOD_FENCE_GATE = BlockRegistry.registerDefaultBlock("redwood_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.REDWOOD, SoundType.CHERRY_WOOD));
        REDWOOD_TRAPDOOR = BlockRegistry.registerDefaultBlock("redwood_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(3.0F).sound(SoundType.CHERRY_WOOD).noOcclusion().isValidSpawn(BlockRegistry::never), RuBlockSetType.REDWOOD));
        REDWOOD_PRESSURE_PLATE = BlockRegistry.registerDefaultBlock("redwood_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.WOOD).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD), RuBlockSetType.REDWOOD));
        REDWOOD_BUTTON = BlockRegistry.registerDefaultBlock("redwood_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.CHERRY_WOOD), RuBlockSetType.REDWOOD, 30, true));
        REDWOOD_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("redwood_sign", () -> new RuStandingSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD), RuWoodTypes.REDWOOD));
        REDWOOD_WALL_SIGN = RegionsUnexploredMod.BLOCK_REGISTRY.register("redwood_wall_sign", () -> new RuWallSignBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.CHERRY_WOOD).dropsLike(REDWOOD_SIGN.get()), RuWoodTypes.REDWOOD));
        //SILVER_BIRCH
        SILVER_BIRCH_LOG = BlockRegistry.registerDefaultBlock("silver_birch_log", () -> BlockRegistry.aspenLogBlock(MaterialColor.SAND, MaterialColor.QUARTZ, SoundType.BAMBOO_WOOD));
        SILVER_BIRCH_WOOD = BlockRegistry.registerDefaultBlock("silver_birch_wood", () -> BlockRegistry.log(MaterialColor.QUARTZ, MaterialColor.QUARTZ, SoundType.BAMBOO_WOOD));
        //WILLOW_BLOCKS
        ...
        WILLOW_FENCE_GATE = BlockRegistry.registerDefaultBlock("willow_fence_gate", () -> BlockRegistry.woodFenceGate(MaterialColor.WOOD, RuWoodTypes.WILLOW, SoundType.WOOD));
